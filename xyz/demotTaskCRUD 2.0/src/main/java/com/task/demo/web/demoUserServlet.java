...
import com.task.demo.dao.demoUserDao;
...
public class demoUserServlet extends HttpServlet {
	...
	private void listUser(HttpServletRequest request, HttpServletResponse response)
		...
		List<demoUser> listUser = demoUserDao.getUsers();
	...
	private void showEditForm(HttpServletRequest request, HttpServletResponse response)
		...
		demoUser existingUser = demoUserDao.selectUser(id);
		RequestDispatcher dispatcher = request.getRequestDispatcher("user/addUser.jsp");
	...
	private void insertUser(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		demoUserDao.addUser(newUser);
		response.sendRedirect("demouser");
	}
	...
	private void updateUser(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
		...
		demoUser book = new demoUser();
		demoUserDao.demoupdateUser(book);
		response.sendRedirect("demouser");
	}
